!function() {
    ...
    function P(e) {
        var t, n, r = e.loaded,
        i = e.total,
        a = e.step; ! L && ((n = _("div")).classList.add("progress"), S(y, n), L = n),
        t = a ? 80 < (t = parseInt(L.style.width || 0, 10) + a) ? 80 : t: Math.floor(r / i * 100),
        L.style.opacity = 1,
        L.style.width = 95 <= t ? "100%": t + "%",
        95 <= t && (clearTimeout(T), T = setTimeout(function(e) {
            L.style.opacity = 0,
            L.style.width = "0%"
        },
        200))
    ...
    var M = i(function(m, e) { !
        function(e) {
            ...
            y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/,
            y._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/,
            y.def = t(y.def).replace("label", y._label).replace("title", y._title).getRegex(),
            y.bullet = /(?:[*+-]|\d+\.)/,
            y.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/,
            y.item = t(y.item, "gm").replace(/bull/g, y.bullet).getRegex(),
            y.list = t(y.list).replace(/bull/g, y.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + y.def.source + ")").getRegex(),
            y._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
            y._comment = /<!--(?!-?>)[\s\S]*?-->/,
            y.html = t(y.html, "i").replace("comment", y._comment).replace("tag", y._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
            y.paragraph = t(y.paragraph).replace("hr", y.hr).replace("heading", y.heading).replace("lheading", y.lheading).replace("tag", y._tag).getRegex(),
            y.blockquote = t(y.blockquote).replace("paragraph", y.paragraph).getRegex(),
            y.normal = g({},
            y),
            y.gfm = g({},
            y.normal, {
            ...
            y.gfm.paragraph = t(y.paragraph).replace("(?!", "(?!" + y.gfm.fences.source.replace("\\1", "\\2") + "|" + y.list.source.replace("\\1", "\\3") + "|").getRegex(),
            y.tables = g({},
            y.gfm, {
                nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
                table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/
            ...
            l.prototype.token = function(e, t) {
                ...
                for (e = e.replace(/^ +$/gm, ""); e;) if ((i = b.rules.newline.exec(e)) && (e = e.substring(i[0].length), 1 < i[0].length && b.tokens.push({
                    type: "space"
                })), i = b.rules.code.exec(e)) e = e.substring(i[0].length),
                i = i[0].replace(/^ {4}/gm, ""),
                b.tokens.push({
                    type: "code",
                ...
                else if (i = b.rules.heading.exec(e)) e = e.substring(i[0].length),
                b.tokens.push({
                    type: "heading",
                    depth: i[1].length,
                    text: i[2]
                    ...
                    b.tokens.push(s)
                } else if (i = b.rules.hr.exec(e)) e = e.substring(i[0].length),
                b.tokens.push({
                    type: "hr"
                });
                else if (i = b.rules.blockquote.exec(e)) e = e.substring(i[0].length),
                b.tokens.push({
                ...
                b.tokens.push({
                    ...
                    b.tokens.push(l), n = !(c = []), g = (i = i[0].match(b.rules.item)).length, h = 0; h < g; h++) p = (s = i[h]).length,
                    ~ (s = s.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") && (p -= s.length, s = b.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + p + "}", "gm"), "")),
                    b.options.smartLists && h !== g - 1 && (a === (o = y.bullet.exec(i[h + 1])[0]) || 1 < a.length && 1 < o.length || (e = i.slice(h + 1).join("\n") + e, h = g - 1)),
                    r = n || /\n\n(?!\s*$)/.test(s),
                    h !== g - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)),
                    r && (l.loose = !0),
                    v = void 0,
                    (m = /^\[[ xX]\] /.test(s)) && (v = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")),
                    u = {
                ...
                b.tokens.links[d] || (b.tokens.links[d] = {
                    ...
                    b.tokens.push(s)
                } else if (i = b.rules.lheading.exec(e)) e = e.substring(i[0].length),
                b.tokens.push({
                    type: "heading",
                    depth: "=" === i[2] ? 1 : 2,
                    text: i[1]
                });
                else if (t && (i = b.rules.paragraph.exec(e))) e = e.substring(i[0].length),
                b.tokens.push({
                    type: "paragraph",
                    text: "\n" === i[1].charAt(i[1].length - 1) ? i[1].slice(0, -1) : i[1]
                });
                else if (i = b.rules.text.exec(e)) e = e.substring(i[0].length),
                b.tokens.push({
                    type: "text",
                    text: i[0]
                });
            ...
            function p(e, t) {
                if (t) {
                    if (p.escapeTest.test(e)) return e.replace(p.escapeReplace,
                    function(e) {
                        return p.replacements[e]
                    })
                } else if (p.escapeTestNoEncode.test(e)) return e.replace(p.escapeReplaceNoEncode,
                function(e) {
                    return p.replacements[e]
                });
                return e
            ...
            function a(e, t) {
                return o[" "+e]||(/^[^:]+:\/*[^/]*$/.test(e)?o[" "+e]=e+"/":o[" "+e]=x(e,"/",!0)),e=o[" "+e],"//"===t.slice(0,2)?e.replace(/:[\s\S]*/,":")+t:"/"===t.charAt(0)?e.replace(/(:\/*[^/]*)[\s\S]*/,"$1")+t:e+t}n._escapes=/\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,n._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,n._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,n.autolink=t(n.autolink).replace("scheme",n._scheme).replace("email",n._email).getRegex(),n._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,n.tag=t(n.tag).replace("comment",y._comment).replace("attribute",n._attribute).getRegex(),n._label=/(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/,n._href=/\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f\\]*\)|[^\s\x00-\x1f()\\])*?)/,
                n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
                n.link = t(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(),
                n.reflink = t(n.reflink).replace("label", n._label).getRegex(),
                n.normal = g({},
                n),
                n.pedantic = g({},
                n.normal, {
                ...
                n.gfm.url = t(n.gfm.url).replace("email", n.gfm._extended_email).getRegex(),
                n.breaks = g({},
                n.gfm, {
                ...
                c.prototype.output = function(e) {
                    for (var t, n, r, i, a, o, s = this,
                    l = ""; e;) if (a = s.rules.escape.exec(e)) e = e.substring(a[0].length),
                    l += a[1];
                    else if (a = s.rules.autolink.exec(e)) e = e.substring(a[0].length),
                    ...
                    l += s.renderer.link(r, null, n);
                        ...
                        !s.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(a[0]) ? s.inRawBlock = !0 : s.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0]) && (s.inRawBlock = !1),
                        e = e.substring(a[0].length),
                        l += s.options.sanitize ? s.options.sanitizer ? s.options.sanitizer(a[0]) : p(a[0]) : a[0];
                        else if (a = s.rules.link.exec(e)) e = e.substring(a[0].length),
                        s.inLink = !0,
                        r = a[2],
                        i = s.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? (r = t[1], t[3]) : "": a[3] ? a[3].slice(1, -1) : "",
                        ...
                        else if (a = s.rules.em.exec(e)) e = e.substring(a[0].length),
                        l += s.renderer.em(s.output(a[6] || a[5] || a[4] || a[3] || a[2] || a[1]));
                        else if (a = s.rules.code.exec(e)) e = e.substring(a[0].length),
                        l += s.renderer.codespan(p(a[2].trim(), !0));
                        else if (a = s.rules.br.exec(e)) e = e.substring(a[0].length),
                        l += s.renderer.br();
                        else if (a = s.rules.del.exec(e)) e = e.substring(a[0].length),
                        l += s.renderer.del(s.output(a[1]));
                        else if (a = s.rules.text.exec(e)) e = e.substring(a[0].length),
                        s.inRawBlock ? l += s.renderer.text(a[0]) : l += s.renderer.text(p(s.smartypants(a[0])));
                        else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                    } else {
                ...
                c.prototype.mangle = function(e) {
                    ...
                    u.prototype.parse = function(e) {
                        ...
                        this.inlineText = new c(e.links, g({},
                        this.options, {
                            renderer: new i
                        })),
                    ...
                    function f(e, n, r) {
                        ...
                        if (r || "function" == typeof n) {
                            ...
                            for (; t < i.length; t++) !
                            function(n) {
                                "code" !== n.type ? --a || s() : o(n.text, n.lang,
                                function(e, t) {
            ...
            a = i(function(e) {
                ...
                u = function() {
                    ...
                    P = c.Prism = {
                        ...
                        languages: {
                            ...
                            insertBefore: function(n, e, t, r) {
                                ...
                                return P.languages.DFS(P.languages,
                                function(e, t) {
                                    t === r[n] && e != n && (this[e] = o)
                                }),
                                r[n] = o
                            ...
                            DFS: function(e, t, n, r) {
                                for (var i in r = r || {},
                                e) e.hasOwnProperty(i) && (t.call(e, i, e[i], n || i), "Object" !== P.util.type(e[i]) || r[P.util.objId(e[i])] ? "Array" !== P.util.type(e[i]) || r[P.util.objId(e[i])] || (r[P.util.objId(e[i])] = !0, P.languages.DFS(e[i], t, i, r)) : (r[P.util.objId(e[i])] = !0, P.languages.DFS(e[i], t, null, r)))
                            }
                        },
                        plugins: {},
                        ...
                        highlightElement: function(e, t, n) {
                            ...
                            e.parentNode && (a = e.parentNode, /pre/i.test(a.nodeName) && (a.className = a.className.replace(l, "").replace(/\s+/g, " ") + " language-" + r));
                            var o = {
                                element: e,
                                language: r,
                                grammar: i,
                            ...
                            if (P.hooks.run("before-sanity-check", o), !o.code || !o.grammar) return o.code && (P.hooks.run("before-highlight", o), o.element.textContent = o.code, P.hooks.run("after-highlight", o)),
                            ...
                            } else o.highlightedCode = P.highlight(o.code, o.grammar, o.language),
                            P.hooks.run("before-insert", o),
                            o.element.innerHTML = o.highlightedCode,
                            n && n.call(e),
                            P.hooks.run("after-highlight", o),
                        ...
                        highlight: function(e, t, n) {
                            ...
                            return P.hooks.run("before-tokenize", r),
                        ...
                        matchGrammar: function(e, t, n, r, i, a, o) {
                            ...
                            for (var l in n) if (n.hasOwnProperty(l) && n[l]) {
                                ...
                                for (var u = 0; u < c.length; ++u) {
                                    ...
                                    p = p.pattern || p;
                                    for (var b = r,
                                    y = i; b < t.length; y += t[b].length, ++b) {
                                        var k = t[b];
                                        if (t.length > e.length) return;
                                        if (! (k instanceof s)) {
                                            if (g && b != t.length - 1) {
                                                if (p.lastIndex = y, !(C = p.exec(e))) break;
                                                for (var x = C.index + (d ? C[1].length: 0), w = C.index + C[0].length, _ = b, S = y, A = t.length; _ < A && (S < w || !t[_].type && !t[_ - 1].greedy); ++_)(S += t[_].length) <= x && (++b, y = S);
                        ...
                        tokenize: function(e, t, n) {
                            ...
                            return P.matchGrammar(e, r, t, 0, 0, !1),
                            r
                        },
                        hooks: {
                            all: {},
                    ...
                    !c.document) return c.addEventListener && (P.disableWorkerMessageHandler || c.addEventListener("message",
                    function(e) {
                    ...
                    return e && (P.filename = e.src, P.manual || e.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(P.highlightAll) : window.setTimeout(P.highlightAll, 16) : document.addEventListener("DOMContentLoaded", P.highlightAll))),
                    c.Prism
                } ();
                ...
                u.languages.markup && (u.languages.insertBefore("markup", "tag", {
                    style: {
            ...
            "undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function() {
                ...
                u.plugins.toolbar && u.plugins.toolbar.registerButton("download-file",
                function(e) {
        ...
        function te(e) {
            void 0 === e && (e = "");
            var r = {};
            return e && (e = e.replace(/^'/, "").replace(/'$/, "").replace(/(?:^|\s):([\w-]+)=?([\w-]+)?/g,
            function(e, t, n) {
        ...
        re = function(i, e) {
            ...
            this.compile = function(n) {
                ...
                e = s(function(e) {
                    r = !1;
                    var t = "";
                    return n ? (t = c(n) ? o(n) : o.parser(n), t = i.noEmoji ? t: t.replace(/<(pre|template|code)[^>]*?>[\s\S]+?<\/(pre|template|code)>/g,
                    function(e) {
        ...
        re.prototype._initRenderer = function() {
            ...
            t.code = e.code = function(e, t) {
                ...
                '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + a.highlight(e, a.languages[t] || a.languages.markup) + "</code></pre>"
            },
            t.link = e.link = function(e, t, n) {
                ...
                o = i.config;
                return t = a,
                X(e) || l._matchNotCompileLink(e) || o.ignore ? r += 0 === e.indexOf("mailto:") ? "": ' target="' + s + '"': (e === l.config.homepage && (e = "README"), e = u.toURL(e, null, u.getCurrentPath())),
            ...
            t.image = e.image = function(e, t, n) {
                ...
                return X(e) || (r = J(p, Q(u.getCurrentPath()), e)),
        ...
        function oe(e, t, r, n) {
            ...
            return i.sort(function(e, t) {
                ...
                n = r ? e.parentNode: e;
                0 !== o.indexOf(t) || a ? $(n, "remove", "active") : (a = e, $(n, "add", "active"))
            }),
            n && (b.title = a ? a.title || a.innerText + " - " + ie: ie),
            a
        }
        var se = function() {
            function r(e, t) {
        ...
        var le = function() {
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    this._shouldTick(t) ? (this.emit("tick", this.next), this.frame = window.requestAnimationFrame(this._tick.bind(this))) : (this.emit("tick", this.end), this.emit("done", null))
                }
            },
            {
                key: "_shouldTick",
        ...
        ue = !1, pe = null, he = !0, de = 0;
        function ge(e) {
            if (he) {
                for (var t, n = v(".sidebar"), r = w(".anchor"), i = x(n, ".sidebar-nav"), a = x(n, "li.active"), o = document.documentElement, s = (o && o.scrollTop || document.body.scrollTop) - de, l = 0, c = r.length; l < c; l += 1) {
                    var u = r[l];
                    if (u.offsetTop > s) {
                        t || (t = u);
                        break
        ...
        function ye(e, i) {
            ...
            function(e, a) {
                ...
                for (; t = n[s++];) {
                    var r = function(i) {
                        return function(e) {
                            var t;
                            if (e) if ("markdown" === i.embed.type) t = o.lexer(e);
            ...
            function(e) {
                ...
                l.links = be[a].links = p,
                i(l)
            })
        }
        function ke() {
            var e = w(".markdown-section>script").filter(function(e) {
        ...
        function xe(e, t, n) {
            var r, i, a;
            return t = "function" == typeof n ? n(t) : "string" == typeof n ? (i = [], a = 0, (r = n).replace(N,
            function(t, e, n) {
            ...
            function(e) {
                for (var t = "",
                n = 0,
                r = e || new Date; n < i.length; n++) t += "string" == typeof i[n] ? i[n] : i[n](r);
                return t
            } (new Date(t))) : t,
        ...
        function we(e) {
            ...
            !1 === this.config.executeScript || void 0 === window.Vue || ke() ? this.config.executeScript && ke() : setTimeout(function(e) {
        ...
        function _e(e) {
            ...
            if (c) {
                ...
                u += (r = '<button class="sidebar-toggle"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' + ((n = t).name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (n.logo ? "<img alt=" + n.name + " src=" + n.logo + ">": n.name) + "</a></h1>": "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>', (m ? r + "<main>": "<main>" + r) + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'),
                e._renderTo(c, u, !0)
            } else e.rendered = !0;
            t.mergeNavbar && m ? p = x(".sidebar") : (l.classList.add("app-nav"), t.repo || l.classList.add("no-badge")),
            t.loadNavbar && A(p, l),
            t.themeColor && (b.head.appendChild(_("div", (o = t.themeColor, "<style>:root{--theme-color: " + o + ";}</style>")).firstElementChild),
            function(n) {
                if (! (window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)"))) {
                    var e = w("style:not(.inserted),link"); [].forEach.call(e,
                    function(e) {
        ...
        Ae.prototype.toURL = function(e, t, n) {
            ...
            i = this.parse(K(e));
            if (i.query = d({},
            i.query, t), e = (e = i.path + G(i.query)).replace(/\.md(\?)|\.md$/, "$1"), r) {
                var a = n.indexOf("?");
        ...
        function Pe(t, n, r, i, a, e) {
            t = e ? t: t.replace(/\/$/, ""),
            (t = Q(t)) && F(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i,
            function(e) {
                return Pe(t, n, r, i, a)
            })
        }
        ...
        var je, Ne, ze, Me, qe = Fe.prototype;qe._init = function() {
            ...
            e.onchange(function(e) {
                Te(r),
                r._updateRender(),
                Le.path !== r.route.path ? (r.$fetch(), Le = r.route) : r.$resetEvents()
            }),
            _e(a),
            Re(a),
            function(t) {
        ...
        qe.route = {},
        (je = qe)._renderTo = function(e, t, n) {
            var r = v(e);
        ...
        je._renderMain = function(r, i, a) {
            var o = this;
            if (void 0 === i && (i = {}), !r) return we.call(this, r);
            h(this, "beforeEach", r,
            function(e) {
                var t, n = function() {
                    i.updatedAt && (t = xe(t, i.updatedAt, o.config.formatUpdated)),
                    h(o, "afterEach", t,
                    function(e) {
                        return we.call(o, e)
                    })
        ...
        Me = function(e, t, n) {
            return ze && ze.abort && ze.abort(),
            ze = F(e, !0, n)
        },
        (Ne = qe)._loadSideAndNav = function(e, t, n, r) {
            var i = this;
            return function() {
                if (!n) return r();
                Pe(e, t, n,
        ...
        Ne._fetchFallbackPage = function(n, r, i) {
            var a = this;
            void 0 === i && (i = p);
            var e = this.config,
            t = e.requestHeaders,
